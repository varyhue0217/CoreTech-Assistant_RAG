...
In the PostgreSQL example above, and with reference to the [PostgreSQL driver documentation](https://jdbc.postgresql.org/documentation/head/connect.html), the following change would enable an encrypted connection:
